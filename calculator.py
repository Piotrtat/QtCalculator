...
class CalculatorWindow(QtWidgets.QMainWindow, Ui_Calculator):
    ...
    #def my_print(self):
        #print('my_time = {}'.format(self.my_timer))
    ...
    def __init__(self):
        ...
        self.pushButton_multiple.clicked.connect(self.binary_operation_pressed)
        ...
        self.pushButton_multiple.setCheckable(True)
        self.pushButton_divide.setCheckable(True)

    def digit_pressed(self):
        button = self.sender()

        if ((self.pushButton_add.isChecked() or self.pushButton_subtract.isChecked() or self.pushButton_multiple.isChecked() or
    ...
    def equals_pressed(self):
        ...
        elif self.pushButton_multiple.isChecked():
            labelNumber = self.firstNum * secondNum
            newLabel = format(labelNumber, '.15g')
            self.label.setText(newLabel)
            self.pushButton_multiple.setChecked(False)
